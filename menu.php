			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="blogView.php"><span class="glyphicon glyphicon-comment"> BLOG</a></li>					<?php if(isset($_SESSION['Category']) && $_SESSION['Category'] == 1): ?>
					<li><a href="solarDrying.php"><span class="glyphicon glyphicon-sunglasses"></span> Solar Drying</a></li>
					<?php endif; ?>					</ul>
				</nav>
			</header>
